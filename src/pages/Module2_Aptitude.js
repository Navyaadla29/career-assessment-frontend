...
function Module2_Aptitude() {
  ...
  const questions = [
    { id: 1, text: "If 3x + 4 = 19, what is the value of x squared?", options: ["25", "16", "36"], correct: "25", scores: [5, 0, 0] },
    { id: 2, text: "Which word does not belong?", options: ["Apple", "Banana", "Potato"], correct: "Potato", scores: [0, 0, 5] },
    { id: 3, text: "2, 4, 6, 8, ? What comes next?", options: ["10", "12", "14"], correct: "10", scores: [5, 0, 0] },
    { id: 4, text: "If it takes 5 machines 5 minutes to make 5 widgets, how long would it take 100 machines to make 100 widgets?", options: ["5 minutes", "100 minutes", "20 minutes"], correct: "5 minutes", scores: [5, 0, 0] },
    { id: 5, text: "Which is the odd one out?", options: ["Triangle", "Square", "Circle"], correct: "Circle", scores: [0, 0, 5] }
  ];
